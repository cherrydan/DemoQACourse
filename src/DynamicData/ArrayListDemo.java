...
Представляет собой автоматически расширяемый массив. ArrayList может менять свой размер во время исполнения программы
МОГУТ иметь внутри себя значения типа null
 */
